...
const authController = {
    ...
    userAccessToken: async (req,res) => {
        try {
            ...
            if(!rf)
                return res.status(StatusCodes.UNAUTHORIZED).json({ msg: "session expired, Loin again"})
    ...
    getAllUsers: async (req,res) => {
        try {
            ...
            const filterUsers = users.filter(item => item.role !== "superadmin")
             
            res.json({ users : filterUsers })
      ...
      updateUser :  async (req,res) => {  
        try {
            ...
            res.status(StatusCodes.OK).json({ msg : "Successfully update the user."})
      ...
      deleteUser :  async (req,res) => {
        try {
            ...
            res.status(StatusCodes.OK).json({ msg : "Successfully delete the user"})
